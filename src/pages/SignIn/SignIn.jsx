...
const SignIn = () => {
    ...
    // Keep usage simple: map input type to state key since name attr is missing in current markup
    // Better: Add name attribute to inputs
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            try {
                ...
                // If parsing fails, use the text as the error message or a default message
                throw new Error(text || 'Server error or invalid response');
            }
    ...
    return (
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-white">
            {/* Left Side - Brand/Illustration (Modified to exclude testimonial as requested) */}
            <div className="hidden lg:flex flex-col justify-center items-center bg-primary-50 p-12 relative overflow-hidden">
                {/* Background elements for premium feel since testimonial is gone */}
                ...
                <div className="relative z-10 text-center">
                    ...
                    <h1 className="text-4xl font-bold text-slate-900 mb-2">PTE Practice</h1>
            ...
            <div className="flex flex-col justify-center items-center p-8 md:p-16 lg:p-24 bg-white relative">
                <div className="w-full max-w-md">
                    ...
                    <div className="lg:hidden flex items-center justify-center gap-2 mb-8">
                        <span className="text-2xl font-bold text-primary-600">&lt; Gurully</span>
                    </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-end mb-8">
                            <Link to="#" className="text-sm font-semibold text-primary-600 hover:text-primary-700 hover:underline">
                                Forgot password?
                            </Link>
                        </div>
                    ...
                    <div className="mt-8 text-center text-slate-500">
                        Don't have an account? <Link to="/select-product" className="font-semibold text-primary-600 hover:text-primary-700 hover:underline">Sign up</Link>
                    </div>
                </div>
            </div>
        </div>
